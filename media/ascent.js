...
function say(text,tone){commsEl.textContent=text;commsEl.classList.remove("st-comms-good","st-comms-bad");if(tone==="good"){commsEl.classList.add("st-comms-good-9873463f");}
if(tone==="bad"){commsEl.classList.add("st-comms-bad-9873463f");}}
...
function logFlight(value,won){var li=document.createElement("li");li.className="st-log-entry-9873463f"+
